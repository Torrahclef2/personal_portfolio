...
@section('title', $pagetitle ?? 'Edit Service')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            @if($service->image && file_exists(public_path('uploads/services/'.$service->image)))
                                <img src="{{ asset('public/uploads/services/'.$service->image) }}" alt="Service Image" style="width: 100px; height: auto; border:1px solid #ddd; padding:4px;">
                            @else
